// built from my fork of kle-serial, only with
// - removed JSON5 dependency,
// - added rotation patch, and a
// - manually browser-ified wrapper
// original: https://github.com/ijprest/kle-serial
// fork: https://github.com/mrzealot/kle-serial
// rotation patch from: https://github.com/kevin-wells/kle-serial

const exports = window.kle = {}

const Key = /** @class */ (function () {
    function Key() {
        this.color = "#cccccc";
        this.labels = [];
        this.textColor = [];
...
exports.Key = Key;
const KeyboardMetadata = /** @class */ (function () {
