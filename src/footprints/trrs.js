...
module.exports = {
  ...
  body: p => {
    const standard = `
      ...
      ${'' /* footprint reference */}
      (fp_text reference "${p.ref}"  (at 0 14.2) hide (layer Dwgs.User) (effects (font (size 1 1) (thickness 0.15))))
      (fp_text value TRRS-PJ-320A-dual (at 0 -5.6) hide (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))
