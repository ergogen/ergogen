module.exports = {
    ...
    body: p => `
        (module rotary_encoder (layer F.Cu) (tedit 603326DE)
            ...
            (pad C thru_hole circle (at -7.62 -0.04) (size 2 2) (drill 1) (layers *.Cu *.Mask) ${p.net.C}))
            (pad B thru_hole circle (at -7.62 2.46) (size 2 2) (drill 1) (layers *.Cu *.Mask) ${p.net.B}))
