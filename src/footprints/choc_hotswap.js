module.exports = {
    ...
    (module Kailh_socket_PG1350_optional (layer F.Cu) (tedit 5DD50F3F)
        ...
        ${'' /* net pads */}
        (pad 1 smd rect (at -3.275 ${p.rot}) (size 2.6 2.6) (layers B.Cu B.Paste B.Mask)  ${p.net.from})
        (pad 2 smd rect (at 8.275 ${p.rot}) (size 2.6 2.6) (layers B.Cu B.Paste B.Mask)  ${p.net.to})
    )
